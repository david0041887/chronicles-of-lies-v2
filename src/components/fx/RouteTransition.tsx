 ...
 *
 * Respects both prefers-reduced-motion (OS) and the in-app Settings
 * toggle via the shared useAppReducedMotion hook. When reduced, drop
 * the y-offset and shorten the duration but keep the cross-fade —
 * hard-snapping page swaps look broken.
 */
